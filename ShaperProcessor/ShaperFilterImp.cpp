...
namespace SHAPER
{
	...
	std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> CFilterImp::CreateAvailableFilters8u1c(ELDER::ImageInfo const& imageInfo)
	{
		std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> availableFilterMap;
	...
	std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> CFilterImp::CreateAvailableFilters16u1c(ELDER::ImageInfo const& imageInfo)
	{
		std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> availableFilterMap;
	...
	std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> CFilterImp::CreateAvailableFilters32f1c(ELDER::ImageInfo const& imageInfo)
	{
		std::map<ProcessorTypes, std::shared_ptr<ELDER::CImageProcessor>> availableFilterMap;
